      ...
      <Box className={styles.infoPage}>
         <Box className={styles.top}>
            <Box className={styles.topLeft}>
               <Box className={styles.avatarWrap}>
                  <Avatar alt='Nguyen Anh Khoa' src='/images/nak.jpg' className={styles.avatar} />
               </Box>
         ...
         <Box className={styles.body}>
            ...
            <Box className={styles.second}>
               <p>
                  ...
                  and timely updated solutions to you with the most enthusiasm and professionalism
                  possible. My skills include a variety of business aspects, ensuring the necessary
                  needs for your satisfaction and both your customers.
               </p>
            </Box>
         ...
         <Box className={styles.contact}>
            ...
            <Box className={styles.bottomRight}>
               ...
               <Box>
                  <a href='https://www.instagram.com/diwas118151' target='_blank' rel='noreferrer'>
                     <Avatar
                        alt='Instargram'
